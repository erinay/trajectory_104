...
numeigvecs = 6;         % select number of eigenvectors to include in dendrogram analysis
...
group = [1 1 1 1 1 1 ]               % select binary code of group of interest. Note: include spaces between digits of binary code
